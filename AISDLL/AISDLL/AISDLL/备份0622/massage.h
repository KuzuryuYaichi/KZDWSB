...
struct info_24_B
{
	...
	unsigned char selection_number;//2
	unsigned char ship_type;//8
	unsigned char seller_ID[6];//42
	unsigned char calling[6];//42
	unsigned int scale;
	unsigned char standby;
};
...
void demode_ship_location(uint8_t *packet);


void demode_UTC_time(uint8_t *packet);


void demode_static_data(uint8_t *packet);


void demode_addressing(uint8_t *packet);


void demode_sefaty_comfirm(uint8_t *packet);


void demode_broadcast_binary(uint8_t *packet);


void demode_searchrescue_info(uint8_t *packet);


void demode_UTCtime_calling(uint8_t *packet);


void demode_addressing_safety(uint8_t *packet);


void demode_safety(uint8_t *packet);


void demode_calling(uint8_t *packet);


void demode_allocation_order(uint8_t *packet);


void demode_GNSS_calling(uint8_t *packet);


void demode_location_B(uint8_t *packet);


void demode_expand_locationB(uint8_t *packet);


void demode_datalink(uint8_t *packet);


void demode_navaids_report(uint8_t *packet);


void demode_channel_manage(uint8_t *packet);
